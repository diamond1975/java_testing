...
public class ContactDeletionTests extends TestBase {
  ...
  public void testsContactDeletion() {
    ...
    //for (int i = 0; i < after.size(); i++) {  Тестовый фреймворк умеет сравнивать списки без цикла. Можно вызвать метод
    //метод ssertEquals и передать два списка, и они будут праивльно сравниваться
